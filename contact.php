...
<head>
	<meta charset="UTF-8">
	<title>Contact || ClaraOPTIC || Clinica oftalmologica </title>
        ...
        <div class="container">
            <div class="outer-box clearfix">
                <div class="header-top-left pull-left">
                    <p>Strada Republicii NR 44, Pucioasa 135400 , RO </p>
                </div>
                <div class="header-top-right pull-right">
                    <div class="header-social-link">
                        <ul>
                            <li>
                                <a href="https://www.facebook.com/clara.optic" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a> 
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="outer-box clearfix">
                ...
                <div class="header-left clearfix pull-left">
                    <div class="logo">
                        <a href="index.html"><img src="assets/images/resources/logo.png" alt="Logo-ul clinicii" title=""></a>
                    </div>
                </div>
                <!--End Header Left-->
                <!--Start Header Right-->
                <div class="header-right pull-right clearfix">
                        ...
                        <nav class="main-menu style1 navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="#">Pagini</a>
                                        <ul>
                                            <li><a href="about.html">Despre noi</a></li>
                                            <li><a href="doctors.html">Echipa noastra </a></li>
                                            
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="#">Servicii</a>
                                        <ul>
                                            <li><a href="services.html">Vezi serviciile noastre </a></li>
                    ...
                    <div class="header-contact">
                        ...
                        <div class="title">
                            <a href="tel:0345 104 233">0345 104 233</a>
        ...
        <div class="row">
            <div class="col-xl-5">
                <div class="contact-p-contact-info-box">
                    <div class="sec-title">
                        <h2><span>Ne-am bucura </span> să auzim părerea <br> clienților noștrii </h2>
                    </div>
                    <div class="inner-content">
                        <ul>
                            <li>
                                ...
                                <div class="text">
                                    <a href="tel:+40345104233">0345104233</a><br>
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <p> Strada Republicii NR 44 <br> Pucioasa,RO</p>
                                </div>
                            </li>
                    ...
                    <form id="contact-form" name="contact_form" class="default-form2" action="contact_form.php" method="post">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="input-box"> 
                                    <input type="text" name="form_name" value="" placeholder="Numele tau" required="">
                                </div>
                                <div class="input-box"> 
                                    <input type="text" name="form_phone" value="" placeholder="Numarul de telefon " required="">
                                </div>     
                            </div>
                            <div class="col-xl-6 col-lg-6">
                                <div class="input-box"> 
                                    <input type="email" name="form_email" value="" placeholder="Adresa de email" required="">
                                </div>
                                <div class="input-box"> 
                                    <input type="text" name="form_subject" value="" placeholder="Subiect " required="">
                                </div>      
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12"> 
                                <div class="input-box">    
                                    <textarea name="form_message" placeholder="Scrie un mesaj " required=""></textarea>
                                </div>
                            </div>
                        </div> 
                        <div class="row">
...
<section class="contact-p-map-area">
    <div class="map-outer">
        ...
        data-zoom="12"
        data-lat="45.081190998946774"
        data-lng="25.433611084292746"
        data-type="roadmap"
        data-hue="#ffc400"
        data-title="ClaraOPTIC"
        data-icon-path="assets/images/resources/map-marker.png"
        data-content="Strada Republicii NR 44, Pucioasa 135400 <br> <a href='mailto:info@youremail.com'> info@youremail.com </a>">
...
<section class="emergency-contact-area" style="background-image: url(assets/images/parallax-background/emergency-contact-area-bg.jpg)">
    <div class="container">
        <div class="row">
            <div class="col-xl-5">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 wow animated fadeInUp" data-wow-delay="0.3s">
                    <div class="single-footer-widget martop16 marbtm">
                        ...
                        <div class="link1 clearfix">
                            <ul class="pull-left">
                                <li><a href="about.html">Despre noi</a></li>    
                                <li><a href="services.html">Tratamente</a></li>             
                                <li><a href="doctors.html">Echipa noastra</a></li>                                    
                            </ul>
                        ...
                        <div class="footer-contact-info">
                            <ul>
                                <li>
                                    ...
                                    <div class="text">
                                        <p><a href="tel:0345 104 233">0345 104 233</a></p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
        ...
        <div class="container">
            <div class="outer-box">
                <div class="copyright-text text-center">
                    <p> Copyright &copy;  2021 | Site proiectat și menținut de <a href="https://alexscanteie.com" target="_black">Scanteie Alexandru</a></p>
                </div>
            </div>    
        </div>    
    </div>
